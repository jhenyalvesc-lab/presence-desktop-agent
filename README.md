...
**Ainda não implementado** (fases futuras, cada uma com sua própria entrega): controle do computador (mouse/teclado/janelas/arquivos), integração com Claude Code/Git/GitHub, fila de comandos, WhatsApp, planner, automações, permissões/confirmação, auditoria.
