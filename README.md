...
**Ainda não implementado** (fases futuras, cada uma com sua própria entrega): integração com Claude Code/Git/GitHub, fila de comandos, WhatsApp, planner, auditoria completa na nuvem.
